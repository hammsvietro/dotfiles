...
(let* ((bg "#070722")
      (err "#fd4663")
      (err-container "#900017")
      (on-background "#f3edf7")
      (on-err "#0e0e43")
      (on-err-container "#fecdd4")
      (on-primary "#0e0e43")
      (on-primary-container "#635900")
      (on-secondary "#0e0e43")
      (on-secondary-container "#cdd0fe")
      (on-surface "#f3edf7")
      (on-surface-variant "#7c80b4")
      (on-tertiary "#0e0e43")
      (on-tertiary-container "#026233")
      (outline-color "#4e4ec2")
      (outline-variant "#323291")
      (primary "#fff59b")
      (primary-container "#e8d000")
      (secondary "#a9aefe")
      (secondary-container "#000ef4")
      (shadow "#070722")
      (surface "#070722")
      (surface-container "#11112d")
      (surface-container-high "#17173c")
      (surface-container-highest "#1c1c4b")
      (surface-container-low "#0c0c27")
      (surface-container-lowest "#090924")
      (surface-variant "#11112d")
      (tertiary "#9bfece")
      (tertiary-container "#00e777")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#9bfece")
      (on-success "#0e0e43")
      (success-container "#00e777")
      (on-success-container "#026233")
      ;; Map fixed colors to regular colors
      (primary-fixed "#fff59b")
      (primary-fixed-dim "#e8d000")
      (secondary-fixed "#a9aefe")
      (secondary-fixed-dim "#000ef4")
      (tertiary-fixed "#9bfece")
      (tertiary-fixed-dim "#00e777")
      (on-primary-fixed "#0e0e43")
      (on-primary-fixed-variant "#635900")
      (on-secondary-fixed "#0e0e43")
      (on-secondary-fixed-variant "#cdd0fe")
      (on-tertiary-fixed "#0e0e43")
      (on-tertiary-fixed-variant "#026233")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#f3edf7")
      (inverse-primary "#fff59b")
      (inverse-surface "#070722")
