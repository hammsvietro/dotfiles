...
(let* ((bg "#1e1e2e")
      ...
      (on-primary "#11111b")
      (on-primary-container "#e4d0fb")
      (on-secondary "#11111b")
      (on-secondary-container "#100701")
      (on-surface "#cdd6f4")
      (on-surface-variant "#a3b4eb")
      (on-tertiary "#11111b")
      (on-tertiary-container "#0e352e")
      (outline-color "#646789")
      (outline-variant "#44465d")
      (primary "#cba6f7")
      (primary-container "#6b02e9")
      (secondary "#fab387")
      (secondary-container "#ce4f00")
      (shadow "#11111b")
      (surface "#1e1e2e")
      ...
      (tertiary "#94e2d5")
      (tertiary-container "#1ba891")
      ;; Map success colors to tertiary (as used in other templates)
      (success "#94e2d5")
      (on-success "#11111b")
      (success-container "#1ba891")
      (on-success-container "#0e352e")
      ;; Map fixed colors to regular colors
      (primary-fixed "#cba6f7")
      (primary-fixed-dim "#6b02e9")
      (secondary-fixed "#fab387")
      (secondary-fixed-dim "#ce4f00")
      (tertiary-fixed "#94e2d5")
      (tertiary-fixed-dim "#1ba891")
      (on-primary-fixed "#11111b")
      (on-primary-fixed-variant "#e4d0fb")
      (on-secondary-fixed "#11111b")
      (on-secondary-fixed-variant "#100701")
      (on-tertiary-fixed "#11111b")
      (on-tertiary-fixed-variant "#0e352e")
      ;; Map inverse colors to surface variants
      (inverse-on-surface "#cdd6f4")
      (inverse-primary "#cba6f7")
